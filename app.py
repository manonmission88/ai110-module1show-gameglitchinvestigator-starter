...
with st.expander("Developer Debug Info"):
    ...
    # Render as plain text to avoid optional dataframe/pandas detection.
    st.text(f"History: {st.session_state.history}")

guess_input_key = f"guess_input_{difficulty}_{st.session_state.game_id}"
    ...
    if not ok:
        ...
        if outcome == "Win":
            ...
            if st.session_state.attempts >= attempt_limit:
                ...
                st.info(f"Try again. Current score: {st.session_state.score}")
